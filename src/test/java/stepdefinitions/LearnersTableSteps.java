...
import utils.BrowserManagerUtilities.BrowserManager;;import java.util.concurrent.TimeUnit;
...
public class LearnersTableSteps extends BrowserManager{
	...
	public void the_user_selects_string_as_academic_year(String inputString) {
		logStep("the user selects " + inputString + " as academic year");
		WebElement selectAcademicYeaR = driver.findElement(selectAcademicYear);
	...
	public void user_select_string_as_state(String inputString) {
		logStep("User select " + inputString + " as State");
		WebElement selectState = driver.findElement(this.selectState);
	...
	public void the_user_clicks_on_the_continue_button() {
		...
		WebElement continu = driver.findElement(continueButton);
	...
	public void user_clicks_on_the_learners_button() {
		...
		WebElement learnerTab = driver.findElement(this.learnerTab);
		click(learnerTab);
	}
	...
	public void system_should_display_the_learner_users_table_to_the_user() {
		...
		WebElement identified = driver.findElement(this.identified);
...
//		logStep(learnersID + learnersName+ learnersAge+ learnersStatus);
		...
		WebElement ViewButton = driver.findElement(this.viewButton);
	...
	public void the_system_display_profile_infornation() {
		...
		WebElement LearnersNameElement = driver.findElement(learnersNameElement);
		WebElement LearnersIDElement = driver.findElement(learnersIDElement);
		WebElement LearnersStstusElement = driver.findElement(learnersStatusElement);
